...
alias fetch="git fetch origin master master-passing-tests"
alias fetchout="git fetch origin master master-passing-tests && git checkout -B master origin/master-passing-tests && git checkout"
alias fetcherge="git fetch origin master master-passing-tests && git merge origin/master-passing-tests --no-edit"
alias fetchbase="git fetch origin master master-passing-tests && git rebase origin/master-passing-tests"
...
alias repoint-test-master="git branch -f qaisjp/test-master origin/master-passing-tests && git push origin qaisjp/test-master:qaisjp/test-master"
